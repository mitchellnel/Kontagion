...
StudentWorld::StudentWorld(string assetPath) : GameWorld(assetPath), socrates(nullptr), m_bacteria(0), m_pits(0)
{}
...
/////////////////////////////////////////////////////////////////
void StudentWorld::decPitCount() {
    m_pits--;
}

void StudentWorld::decBacteriaCount() {
    m_bacteria--;
}
...
bool StudentWorld::bacteriaSocratesOverlap(Bacteria* bacteria) {
...
bool StudentWorld::bacteriaMovementBlocked(const double& attemptX, const double& attemptY) const {
...
bool StudentWorld::nearSocrates(Bacteria* bacteria, double& socratesX, double& socratesY, const double& dist) {
...
bool StudentWorld::canEatFood(Bacteria* bacteria) {
    for (auto itr = actors.begin(); itr != actors.end(); ) {
...
bool StudentWorld::findFood(Bacteria* bacteria, double& foodX, double& foodY) {
...
void StudentWorld::dropFood(double x, double y) {
...
/////////////////////////////////////////////////////////////////
void StudentWorld::spawnRegSal(double startX, double startY) {
    actors.push_back(new RegularSalmonella(this, startX, startY));
    m_bacteria++;
}

void StudentWorld::spawnAggSal(double startX, double startY) {
    actors.push_back(new AggressiveSalmonella(this, startX, startY));
    m_bacteria++;
}

void StudentWorld::spawnEColi(double startX, double startY) {
...
void StudentWorld::flameDamage(Projectile* flame) {
    for (auto itr = actors.begin(); itr != actors.end(); ) {
...
///////////////////////////////////////////////////////////////
void StudentWorld::sprayDisinfectant() {
...
void StudentWorld::sprayDamage(Projectile* spray) {
    for (auto itr = actors.begin(); itr != actors.end(); ) {
...
//////////////////////////////////////////////////////////////////////////////////////////////
void StudentWorld::rechargeFlamethrower() {
...
/////////////////////////////////////////////////////////////////
void StudentWorld::fungusHurtSocrates() {
...
/////////////////////////////////////////////////
void StudentWorld::generateRandPos(double& x, double& y) {
...
void StudentWorld::generateRandPosOnBorder(double& x, double& y) {
...
void StudentWorld::addGoodiesOrFungi() {
