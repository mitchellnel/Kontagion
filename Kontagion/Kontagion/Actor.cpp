...
///////////////////////////////////////////////////
Actor::Actor(StudentWorld* world, int imageID, double startX, double startY, Direction startDir, int depth) : GraphObject(imageID, startX, startY, startDir, depth), m_world(world), m_alive(true)
{}
...
/////////////////////////////////////////////////////////////
Damageable::Damageable(StudentWorld* world, int imageID, double startX, double startY, Direction startDir, int depth) : Actor(world, imageID, startX, startY, startDir, depth)
{}
...
/////////////////////////////////////////////////////////////
Character::Character(StudentWorld* world, int imageID, double startX, double startY, int startHP, Direction startDir) : Damageable(world, imageID, startX, startY, startDir, 0), m_health(startHP)
{}
...
/////////////////////////////////////////////////////////
Socrates::Socrates(StudentWorld* world) : Character(world, IID_PLAYER, 0, VIEW_HEIGHT/2, 100), m_sprayCharges(20), m_flameCharges(5)
{}
...
//////////////////////////////////////////////////////////
Bacteria::Bacteria(StudentWorld* world, int imageID, double startX, double startY, int startHP, int damageToken) : Character(world, imageID, startX, startY, startHP, up), m_damageToken(damageToken), m_movementPlanDist(0), m_foodEaten(0)
{}
...
/////////////////////////////////////////////////////////////
Salmonella::Salmonella(StudentWorld* world, double startX, double startY, int startHP, int damageToken) : Bacteria(world, IID_SALMONELLA, startX, startY, startHP, damageToken)
{}
...
//////////////////////////////////////////////////////////
EColi::EColi(StudentWorld* world, double startX, double startY) : Bacteria(world, IID_ECOLI, startX, startY, 10, 4)
{}
...
/////////////////////////////////////////////////////////
Goodie::Goodie(StudentWorld* world, int imageID, double startX, double startY, int lifetime, int scoreVal) : Damageable(world, imageID, startX, startY), m_timeRemaining(lifetime), m_scoreValue(scoreVal)
{}
...
// Dirt Implementation
/////////////////////////////////////////////////////////
Dirt::Dirt(StudentWorld* world, double startX, double startY) : Damageable(world, IID_DIRT, startX, startY)
{}
...
/////////////////////////////////////////////////////////
Projectile::Projectile(StudentWorld* world, int imageID, double startX, double startY, Direction startDir, int maxTravelDist, int damageToken)
...
/////////////////////////////////////////////////////////
Flame::Flame(StudentWorld* world, double startX, double startY, Direction startDir) : Projectile(world, IID_FLAME, startX, startY, startDir, 32, 5)
{}
...
/////////////////////////////////////////////////////////
Spray::Spray(StudentWorld* world, double startX, double startY, Direction startDir) : Projectile(world, IID_SPRAY, startX, startY, startDir, 112, 2)
{}
...
// Food Implementation
/////////////////////////////////////////////////////////
Food::Food(StudentWorld* world, double startX, double startY) : Actor(world, IID_FOOD, startX, startY, up, 1)
{}
...
// Pit Implementation
/////////////////////////////////////////////////////////
Pit::Pit(StudentWorld* world, double startX, double startY) : Actor(world, IID_PIT, startX, startY, right, 1), m_regSalLeft(5), m_aggSalLeft(3), m_eColiLeft(2)
{
