...
public:
    Actor(StudentWorld* world, int imageID, double startX, double startY, Direction startDirection, int depth = 0);
    virtual ~Actor() {}
...
public:
    Damageable(StudentWorld* world, int imageID, double startX, double startY, Direction startDir = right, int depth = 1);
    virtual ~Damageable() {}
        // Identifier
    virtual bool isDamageable() const;
};
...
public:
    Character(StudentWorld* world, int imageID, double startX, double startY, int startHP, Direction startDir = right);
    virtual ~Character() {}
        // Identifier
    virtual bool isCharacter() const;
...
public:
    Bacteria(StudentWorld* world, int imageID, double startX, double startY, int startHP, int damageToken);
    virtual ~Bacteria() {}
...
public:
    Salmonella(StudentWorld* world, double startX, double startY, int startHP, int damageToken);
    virtual ~Salmonella() {}
...
public:
    Goodie(StudentWorld* world, int imageID, double startX, double startY, int lifetime, int scoreVal);
    virtual ~Goodie() {}
...
public:
    Projectile(StudentWorld* world, int imageID, double startX, double startY, Direction startDir, int maxTravelDist, int damageToken);
    virtual ~Projectile() {}
...
public:
    Flame(StudentWorld* world, double startX, double startY, Direction startDir);
...
public:
    Spray(StudentWorld* world, double startX, double startY, Direction startDir);
    virtual void specificProjectileAction();
};
